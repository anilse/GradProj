...
x = Conv2D(16, kernel_size=(3, 3), strides=1)(inputs)
x = BatchNormalization(scale=False, center=True)(x)
x = Activation('relu')(x)
x = Dropout(rate=0.1)(x)

x = Conv2D(32, kernel_size=(3, 3), strides=1)(x)
x = BatchNormalization(scale=False, center=True)(x)
x = Activation('relu')(x)
x = Dropout(rate=0.1)(x)
...
x = Conv2D(256, kernel_size=(5, 5), strides=2)(x)
x = BatchNormalization(scale=False, center=True)(x)
x = Activation('relu')(x)
x = Dropout(rate=0.1)(x)
...
steps_per_epoch = 121909 / BATCH_SIZE
